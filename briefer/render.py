...
:root{
  ...
  --line:rgba(23,26,33,.19); --line-2:rgba(23,26,33,.055);
  --gold:#0E9E7E; --gold-br:#0E9E7E;   /* VAAX 에메랄드 그린 (내부 변수명은 레거시) */
...
.shell{max-width:520px;margin:0 auto;min-height:100vh;position:relative;
  background:
    radial-gradient(120% 46% at 86% -8%, rgba(14,158,126,.13), transparent 62%),
    var(--paper);
...
@keyframes pulse{0%{box-shadow:0 0 0 0 rgba(14,158,126,.5)}70%{box-shadow:0 0 0 7px rgba(14,158,126,0)}100%{box-shadow:0 0 0 0 rgba(14,158,126,0)}}
...
/* why (핵심) */
.why{background:#EFEFEC;border:1px solid rgba(23,26,33,.16);
...
:root{--paper:#F1F2F5;--card:#FFF;--ink:#171A21;--ink-dim:#4B525E;--muted:#8B929E;
 --line:rgba(23,26,33,.19);--yeon:#0E9E7E;--yeon-br:#0E9E7E;--yeon-tint:#EFEFEC;
 --mono:"Pretendard Variable",Pretendard,-apple-system,system-ui,sans-serif;
 --kr:"Pretendard Variable",Pretendard,-apple-system,system-ui,sans-serif;}
...
.search input:focus{border-color:var(--yeon-br);box-shadow:0 0 0 3px rgba(14,158,126,.15)}
...
.story .why{margin-top:8px;background:var(--yeon-tint);border:1px solid rgba(23,26,33,.16);
...
mark{background:rgba(14,158,126,.32);color:inherit;border-radius:2px}
